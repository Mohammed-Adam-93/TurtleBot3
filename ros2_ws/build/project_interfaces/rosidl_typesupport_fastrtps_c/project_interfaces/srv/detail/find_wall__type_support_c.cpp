...
#include "project_interfaces/srv/detail/find_wall__rosidl_typesupport_fastrtps_c.h"
...
using _FindWall_Request__ros_msg_type = project_interfaces__srv__FindWall_Request;
...
size_t get_serialized_size_project_interfaces__srv__FindWall_Request(
  const void * untyped_ros_message,
...
static uint32_t _FindWall_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_project_interfaces__srv__FindWall_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_interfaces
size_t max_serialized_size_project_interfaces__srv__FindWall_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_project_interfaces__srv__FindWall_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, srv, FindWall_Request)() {
...
using _FindWall_Response__ros_msg_type = project_interfaces__srv__FindWall_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_interfaces
size_t get_serialized_size_project_interfaces__srv__FindWall_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FindWall_Response__ros_msg_type * ros_message = static_cast<const _FindWall_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_project_interfaces__srv__FindWall_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_interfaces
size_t max_serialized_size_project_interfaces__srv__FindWall_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_project_interfaces__srv__FindWall_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, srv, FindWall_Response)() {
...
// already included above
// #include "project_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "project_interfaces/srv/find_wall.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, srv, FindWall)() {
