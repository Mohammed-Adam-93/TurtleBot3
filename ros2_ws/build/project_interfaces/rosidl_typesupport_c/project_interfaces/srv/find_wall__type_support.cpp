...
#include "project_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _FindWall_Request_type_support_symbol_names_t _FindWall_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, srv, FindWall_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, project_interfaces, srv, FindWall_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_project_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, project_interfaces, srv, FindWall_Request)() {
  return &::project_interfaces::srv::rosidl_typesupport_c::FindWall_Request_message_type_support_handle;
}
...
static const _FindWall_Response_type_support_symbol_names_t _FindWall_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, srv, FindWall_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, project_interfaces, srv, FindWall_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_project_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, project_interfaces, srv, FindWall_Response)() {
  return &::project_interfaces::srv::rosidl_typesupport_c::FindWall_Response_message_type_support_handle;
}
...
static const _FindWall_type_support_symbol_names_t _FindWall_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_interfaces, srv, FindWall)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, project_interfaces, srv, FindWall)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, project_interfaces, srv, FindWall)() {
  return &::project_interfaces::srv::rosidl_typesupport_c::FindWall_service_type_support_handle;
}
