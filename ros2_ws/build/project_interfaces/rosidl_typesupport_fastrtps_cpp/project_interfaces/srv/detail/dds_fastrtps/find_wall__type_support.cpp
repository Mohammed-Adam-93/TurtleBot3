...
#include "project_interfaces/srv/detail/find_wall__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const project_interfaces::srv::FindWall_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::srv::FindWall_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const project_interfaces::srv::FindWall_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<project_interfaces::srv::FindWall_Request *>(
    untyped_ros_message);
...
{
  return &project_interfaces::srv::typesupport_fastrtps_cpp::_FindWall_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, srv, FindWall_Request)() {
  return &project_interfaces::srv::typesupport_fastrtps_cpp::_FindWall_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_project_interfaces
cdr_serialize(
  const project_interfaces::srv::FindWall_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: wallfound
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  project_interfaces::srv::FindWall_Response & ros_message)
{
  // Member: wallfound
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const project_interfaces::srv::FindWall_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<project_interfaces::srv::FindWall_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &project_interfaces::srv::typesupport_fastrtps_cpp::_FindWall_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, srv, FindWall_Response)() {
  return &project_interfaces::srv::typesupport_fastrtps_cpp::_FindWall_Response__handle;
}
...
{
  return &project_interfaces::srv::typesupport_fastrtps_cpp::_FindWall__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, project_interfaces, srv, FindWall)() {
  return &project_interfaces::srv::typesupport_fastrtps_cpp::_FindWall__handle;
}
